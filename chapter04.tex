...
\index{capture request header}
  ...
  See also: \kwl{capture cookie}, "capture response header" as well as section 8
             about logging.
...
\dflb{no}{yes}{yes}{no}
  ...
  See also: "default\_backend", "tcp-request", and section 7 about ACLs.
...
\dflb{no}{no}{yes}{yes}
  ...
  See also: "use\_backend", serction 5 about server and section 7 about ACLs.
