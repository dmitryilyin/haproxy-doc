...
\dflb{yes}{yes}{yes}{yes}
  ...
  timeout defined by \kw{timeout http-keep-alive} or \kw{timeout http-request} if
  not set.
...
\dflb{yes}{yes}{yes}{yes}
  ...
  compile time, and may be globally disabled with the global option \kw{nosplice}.
...
See also: the \kwl{usesrc} argument of the \kwl{source} keyword, and the
            \kw{transparent} option of the \kw{bind} keyword.
...
\dflb{yes}{no}{yes}{yes}
  ...
  in the request buffer. This is the same requirement as with the \kw{rdp-cookie}
...
\dflb{yes}{yes}{yes}{no}
  ...
  sense to increase the socket's backlog using the \kw{backlog} keyword.
  ...
  \emph{Note:} when the maximum rate is reached, the frontend's status is not changed
         ...
         \kw{socket-stats} option is enabled.
...
\dflb{no}{yes}{yes}{yes}
  ...
  \item[<search>] is the regular expression applied to HTTP headers and to the
              ...
              The \kw{rspdel} keyword strictly matches case while \kw{rspidel}
              ignores case.
...
\dflb{no}{yes}{yes}{yes}
  ...
  \item[<search>] is the regular expression applied to HTTP headers and to the
              ...
              is required. Any space or known delimiter must be escaped using
              a backslash \chr{\bslash}. The pattern applies to a full line at a time.
              The \kw{rspdeny} keyword strictly matches case while \kw{rspideny}
              ignores case.
...
\dflb{no}{yes}{yes}{yes}
  ...
  \item[<search>] is the regular expression applied to HTTP headers and to the
              ...
              is required. Any space or known delimiter must be escaped using
              a backslash \chr{\bslash}. The pattern applies to a full line at a time.
              The \kw{rsprep} keyword strictly matches case while \kw{rspirep}
              ignores case.
