...
\subsubsection[tcp-request inspect-delay <timeout>
...
\subsubsection[tcp-response inspect-delay <timeout>
...
\subsubsection[unique-id-header <name>
...
\subsubsection[use_backend <backend> if <condition>
\subsubsection[use_backend <backend> unless <condition>
...
\subsubsection[use-server <server> if <condition>
\subsubsection[use-server <server> unless <condition>
