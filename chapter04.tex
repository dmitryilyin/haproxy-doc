...
\dflb{yes}{yes}{yes}{yes}
  ...
  When this happens, it is possible to use \opt{forceclose}. It will
...
\dflb{yes}{yes}{yes}{yes}
  ...
  and that combining \kw{http-server-close} with \kw{httpclose}
  basically achieve the same result as \kw{forceclose}.
...
\dflb{yes}{no}{yes}{yes}
  ...
  \site{http://tools.ietf.org/html/rfc4511#section-4.1.9}
...
\subsubsection{option \kw{log-health-checks}}
...
\subsubsection{persist \kw{rdp-cookie}}
