...
\subsubsection{no option accept-invalid-http-request}
  \index{option accept-invalid-http-request}
  \index{no option accept-invalid-http-request}
...
\index{option accept-invalid-http-response}
\index{no option accept-invalid-http-response}
...
\index{option allbackups}
\index{no option allbackups}
...
\index{option checkcache}
\index{no option checkcache}
...
\index{option clitcpka}
\index{no option clitcpka}
...
\index{option dontlog-normal}
\index{no option dontlog-normal}
...
\index{option dontlognull}
\index{no option dontlognull}
...
\index{option forceclose}
\index{no option forceclose}
...
\index{option http-no-delay}
\index{no option http-no-delay}
...
\index{option http-pretend-keepalive}
\index{no option http-pretend-keepalive}
...
\index{option http-server-close}
\index{no option http-server-close}
...
\index{option http-use-proxy-header}
\index{no option http-use-proxy-header}
...
\index{option httpclose}
\index{no option httpclose}
...
\index{option http\_proxy}
\index{no option http\_proxy}
...
\index{option independant-streams}
\index{no option independant-streams}
...
\index{option log-health-checks}
\index{no option log-health-checks}
...
\index{option log-separate-errors}
\index{no option log-separate-errors}
...
\index{option logasap}
\index{no option logasap}
...
\index{option nolinger}
\index{no option nolinger}
...
\index{option persist}
\index{no option persist}
...
\index{option redispatch}
\index{no option redispatch}
...
\index{option socket-stats}
\index{no option socket-stats}
