...
\index{bind}
  ...
  See also: \kwl{source}, \optl{forwardfor}, \kwl{unix-bind} and the PROXY protocol
             documentation.
...
\index{capture request header}
  ...
  See also: \kwl{capture cookie}, \kwl{capture response header} as well as section 8
             about logging.
...
\index{capture response header}
  ...
  See also: \kwl{capture cookie}, \kwl{capture request header} as well as section 8
             about logging.
...
\index{default-server}
  ...
  See also: \kwl{server} and section 5 about server options
...
\end{verbatim}
  ...
  See also: \kwl{stats http-request}, section 3.4 about userlists and section 7
             about ACL usage.
...
\index{ignore-persist}
  ...
  See also: \kwl{force-persist}, \kwl{cookie}, and section 7 about ACL usage.
...
\subsubsection[abortonclose]{option abortonclose}
\subsubsection[abortonclose]{no option abortonclose}
\index{abortonclose}
...
\subsubsection[allbackups]{option allbackups}
\subsubsection[allbackups]{no option allbackups}
...
\subsubsection[checkcache]{option checkcache}
\subsubsection[checkcache]{no option checkcache}
...
\subsubsection[clitcpka]{option clitcpka}
\subsubsection[clitcpka]{no option clitcpka}
...
\subsubsection[contstats]{option contstats}
...
\dflb{yes}{yes}{yes}{no}
  ...
  See also: \kwl{log}, \kwl{dontlognull}, \kwl{log-separate-errors} and section 8 about
             logging.

\subsubsection[dontlognull]{option dontlognull}
\subsubsection[dontlognull]{no option dontlognull}
...
\dflb{yes}{yes}{yes}{no}
  ...
  See also: \kwl{log}, \kwl{monitor-net}, \kwl{monitor-uri} and section 8 about logging.

\subsubsection[forceclose]{option forceclose}
\subsubsection[forceclose]{no option forceclose}
...
\subsubsection[forwardfor]{option forwardfor [ except <network> ] [ header <name> ] [ if-none ]}
...
\dflb{yes}{yes}{yes}{no}
  ...
  See also: \kwl{option httpclose}, \kwl{option forceclose} and "option
             http-server-close".


\subsubsection[httpchk]{option httpchk}
...
\subsubsection[httpclose]{option httpclose}
\subsubsection[httpclose]{no option httpclose}
...
\subsubsection[httplog]{option httplog [ clf ]}
...
\subsubsection[http\_proxy]{option http\_proxy}
\subsubsection[http\_proxy]{no option http\_proxy}
...
\dflb{yes}{no}{yes}{yes}
  ...
  See also: \kwl{log} and section 8 about logging.
...
\dflb{yes}{yes}{yes}{no}
  ...
  See also: \kwl{log}, \kwl{dontlognull}, \kwl{dontlog-normal} and section 8 about
             logging.

\subsubsection[logasap]{option logasap}
\subsubsection[logasap]{no option logasap}
...
\end{verbatim}
  ...
  See also: \kwl{option httplog}, \kwl{capture response header}, and section 8 about
             logging.

\subsubsection[mysql-check]{option mysql-check [ user <username> ]}
\index{mysql-check}
...
\subsubsection[pgsql-check]{option pgsql-check [ user <username> ]}
...
\subsubsection[nolinger]{option nolinger}
\subsubsection[nolinger]{no option nolinger}
...
\subsubsection[originalto]{option originalto [ except <network> ] [ header <name> ]}
...
\subsubsection[persist]{option persist}
\subsubsection[persist]{no option persist}
...
\subsubsection[redispatch]{option redispatch}
\subsubsection[redispatch]{no option redispatch}
...
\subsubsection[smtpchk]{option smtpchk}
...
\subsubsection[srvtcpka]{option srvtcpka}
\subsubsection[srvtcpka]{no option srvtcpka}
...
\subsubsection[tcpka]{option tcpka}
...
\subsubsection[tcplog]{option tcplog}
...
\dflb{yes}{yes}{yes}{yes}
  ...
  See also: \kwl{option httplog}, and section 8 about logging.

\subsubsection[transparent]{option transparent}
\subsubsection[transparent]{no option transparent}
...
\end{verbatim}
  ...
  See also: \kwl{rspadd}, section 6 about HTTP header manipulation, and section 7
            about ACLs.
...
\end{verbatim}
  ...
  See also: \kwl{reqdeny}, \kwl{block}, section 6 about HTTP header manipulation, and
...
\end{verbatim}
  ...
  See also: \kwl{reqallow}, \kwl{rspdeny}, \kwl{block}, section 6 about HTTP header
            manipulation, and section 7 about ACLs.
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{reqallow}, \kwl{reqdeny}, \kwl{block}, section 6 about HTTP header
            manipulation, and section 7 about ACLs.
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{reqadd}, \kwl{reqdel}, \kwl{rsprep}, section 6 about HTTP header
            manipulation, and section 7 about ACLs.
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{reqallow}, \kwl{reqdeny}, \kwl{reqpass}, section 6 about HTTP header
            manipulation, and section 7 about ACLs.
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{reqadd}, section 6 about HTTP header manipulation, and section 7
            about ACLs.
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{rspadd}, \kwl{rsprep}, \kwl{reqdel}, section 6 about HTTP header
            manipulation, and section 7 about ACLs.
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{reqdeny}, \kwl{acl}, \kwl{block}, section 6 about HTTP header manipulation
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{rspadd}, \kwl{rspdel}, \kwl{reqrep}, section 6 about HTTP header
            manipulation, and section 7 about ACLs.
...
\dflb{no}{no}{yes}{yes}
  ...
  See also: \kwl{default-server}, \kwl{http-send-name-header} and section 5 about
             server options
...
\dflb{yes}{no}{yes}{yes}
  ...
  See also: the \kwl{source} server option in section 5, the Tproxy patches for
...
\dflb{no}{no}{yes}{yes}
  ...
  See also: \kwl{http-request}, section 3.4 about userlists and section 7
             about ACL usage.
...
\dflb{no}{no}{yes}{yes}
  ...
  See also: \kwl{stick-table}, \kwl{stick on}, \kwl{nbproc}, \kwl{bind-process} and section 7
...
\dflb{no}{yes}{yes}{yes}
  ...
  See also: \kwl{stick match}, \kwl{stick on}, \kwl{stick store-request}, section 2.2
...
\dflb{no}{no}{yes}{yes}
  ...
  See also: \kwl{stick-table}, \kwl{stick on}, and section 7 about ACLs and pattern
             extraction.


\subsubsection[tcp-request connection]{tcp-request connection <action> [ \{if | unless\} <condition> ]}
...
\dflb{no}{yes}{yes}{no}
  ...
  See also: \kwl{default\_backend}, \kwl{tcp-request}, and section 7 about ACLs.
...
\dflb{no}{no}{yes}{yes}
  ...
  See also: \kwl{use\_backend}, serction 5 about server and section 7 about ACLs.
