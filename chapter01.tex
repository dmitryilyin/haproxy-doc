...
sides. Use \optl{http-server-close} to preserve client persistent connections
while handling every incoming request individually, dispatching them one after
another to servers, in HTTP close mode. Use \optl{httpclose} to switch both
sides to HTTP close mode. The \optl{forceclose} and \optl{http-pretend-keepalive} help working around servers misbehaving in HTTP close
mode.
