...
\subsubsection[addr]{\kw{addr} <ipv4|ipv6>}
  ...
  the \kwl{check} parameter is not set. See also: the \kwl{port} parameter.
...
\subsubsection[backup]{\kw{backup}}
  ...
  the \kwl{allbackups} option is set in the backend. See also: the \kwl{allbackups}
  option.
...
\subsubsection[cookie]{\kw{cookie} <value>}
  ...
  backup servers. See also: the \kwl{cookie} keyword in backend section.
...
\subsubsection[fall]{\kw{fall} <count>}
  ...
  unspecified. See also: the \kwl{check}, \kwl{inter} and \kwl{rise} parameters.
...
\subsubsection[maxconn]{\kw{maxconn} <maxconn>}
  ...
  which means unlimited. See also: the \kwl{minconn} and \kwl{maxqueue} parameters, and
...
\subsubsection[maxqueue]{\kw{maxqueue} <maxqueue>}
  ...
  default value is \kwl{0} which means the queue is unlimited. See also: the
...
\subsubsection[minconn]{\kw{minconn} <minconn>}
  ...
  overloading the server during exceptional loads. See also: the \kwl{maxconn}
...
\subsubsection[port]{\kw{port} <port>}
  ...
  set. See also: the \kwl{addr} parameter.
...
\subsubsection[rise]{\kw{rise} <count>}
  ...
  if unspecified. See also: the \kwl{check}, \kwl{inter} and \kwl{fall} parameters.
...
\subsubsection[send-proxy]{\kw{send-proxy}}
  ...
  used if the server isn't aware of the protocol. See also: the \kwl{accept-proxy}
