...
\begin{figure}[!ht]
  ...
  \node[below,text width=2cm] at (lb1.south)
  {haproxy keepalived};
  \node[below,text width=2cm] at (lb2.south)
  {haproxy keepalived};  
...
%14
\node[marker,text width=14cm] at (5,-14) {The proxy sees the cookie, removes the server name and forwards to server A which sees the same cookie as it previously sent.};
%15
...
\node[cld,inner sep=0pt,right of=n3,xshift=3cm](nr1){ \includegraphics{../pic/router} };
...
%office 1
\node[cld,above of=n1,inner sep=0pt,yshift=2cm](or1){ \includegraphics{../pic/router} };
...
%office 2
\node[cld,inner sep=0pt,above of=n3,yshift=2cm](or2){ \includegraphics{../pic/router} };
...
%office 3
\node[cld,above of=n4,inner sep=0pt,yshift=2cm](or3){ \includegraphics{../pic/router} };
...
%site1
\node[cld,inner sep=0pt,below of=n2,yshift=-2cm](sr1){ \includegraphics{../pic/router} };
\draw (sr1) -- (n2);
...
%site2
\node[cld,inner sep=0pt,below of=n5,yshift=-2cm](sr2){ \includegraphics{../pic/router} };
\draw (sr2) -- (n5);
...
%site link
\node[cld,right of=s1-9,inner sep=0pt,xshift=1.5cm](sl){ \includegraphics{../pic/router} };
\draw (s1-9) -- (sl);
\draw (s2-1) -- (sl);
...
\begin{figure}[!ht]
  ...
  \node[below] at (lb1.south) {haproxy};  
  \node[below,text width=4.5cm] at (web-b.south)
  {3 application servers with heavy frameworks};
