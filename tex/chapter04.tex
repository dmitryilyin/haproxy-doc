...
\subsubsection[abortonclose]{\kw{option abortonclose}}
...
\subsubsection[accept-invalid-http-request]{\kw{option accept-invalid-http-request}}
...
\subsubsection[accept-invalid-http-response]{\kw{option accept-invalid-http-response}}
...
\subsubsection[allbackups]{\kw{option allbackups}}
...
\subsubsection[checkcache]{\kw{option checkcache}}
...
\subsubsection[clitcpka]{\kw{option clitcpka}}
...
\subsubsection[contstats]{\kwl{option contstats}}
\index{contstats}
...
\subsubsection[dontlog-normal]{\kwl{option dontlog-normal}}
...
\subsubsection[dontlognull]{\kw{option dontlognull}}
...
\subsubsection[forceclose]{\kw{option forceclose}}
...
\subsubsection[forwardfor]{\kw{option forwardfor} [ except <network> ] [ header <name> ] [ if-none ]}
\index{forwardfor}
...
\subsubsection[http-no-delay]{\kw{option http-no-delay}}
...
\subsubsection[http-pretend-keepalive]{\kw{option http-pretend-keepalive}}
...
\subsubsection[http-server-close]{\kw{option http-server-close}}
...
\subsubsection[http-use-proxy-header]{\kw{option http-use-proxy-header}}
...
\subsubsection[httpchk]{\kw{option httpchk}}
...
\subsubsection[httpclose]{\kw{option httpclose}}
...
\subsubsection[httplog]{\kw{option httplog} [ clf ]}
\index{httplog}
...
\subsubsection[http\_proxy]{\kw{option http\_proxy}}
...
\subsubsection[independant-streams]{\kw{option independant-streams}}
...
\subsubsection[ldap-check]{\kw{option ldap-check}}
...
\subsubsection[log-health-checks]{\kw{option log-health-checks}}
...
\subsubsection[log-separate-errors]{\kw{option log-separate-errors}}
...
\subsubsection[logasap]{\kw{option logasap}}
...
\subsubsection[pgsql-check]{\kw{option pgsql-check} [ user <username> ]}
...
\subsubsection[nolinger]{\kw{option nolinger}}
...
\subsubsection[originalto]{\kw{option originalto} [ except <network> ] [ header <name> ]}
...
\subsubsection[persist]{\kw{option persist}}
...
\subsubsection[redispatch]{\kw{option redispatch}}
...
\subsubsection[redis-check]{\kw{option redis-check}}
...
\subsubsection[smtpchk]{\kw{option smtpchk}}
...
\subsubsection[socket-stats]{\kw{option socket-stats}}
...
\subsubsection[splice-auto]{\kw{option splice-auto}}
...
\subsubsection[splice-request]{\kw{option splice-request}}
...
\subsubsection[splice-response]{\kw{option splice-response}}
...
\subsubsection[srvtcpka]{\kw{option srvtcpka}}
...
\subsubsection[ssl-hello-chk]{\kw{option ssl-hello-chk}}
...
\subsubsection[tcp-smart-accept]{\kw{option tcp-smart-accept}}
...
\subsubsection[tcp-smart-accept]{\kw{option tcp-smart-connect}}
...
\subsubsection[tcpka]{\kw{option tcpka}}
\index{tcpka}
...
\subsubsection[tcplog]{\kw{option tcplog}}
...
\subsubsection[transparent]{\kw{option transparent}}
