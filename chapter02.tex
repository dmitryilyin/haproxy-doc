...
\item the \cfgsec{global} section, which sets process-wide parameters
\item the proxies sections which can take form of \cfgsec{defaults}, \cfgsec{listen},
    \cfgsec{frontend} and \cfgsec{backend}.
\end{enumerate}
