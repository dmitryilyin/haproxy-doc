...
exception of the backslash ("\textbackslash") which makes it possible to escape some
...
they are passed, with the exception of the backslash ("\textbackslash") which makes it
...
\subsubsection{sc2\_bytes\_in\_rate}
...
\subsubsection src_get_gpc0 <integer>
\subsubsection src_get_gpc0(<table>) <integer>
  Returns the value of the first General Purpose Counter associated to the
  connection's source IPv4 address in the current proxy's stick-table or in
  the designated stick-table. If the address is not found, zero is returned.
  See also sc1/sc2_get_gpc0 and src_inc_gpc0.

\subsubsection src_http_err_cnt <integer>
\subsubsection src_http_err_cnt(<table>) <integer>
...
\subsubsection src_http_err_rate <integer>
\subsubsection src_http_err_rate(<table>) <integer>
...
\subsubsection src_http_req_cnt <integer>
\subsubsection src_http_req_cnt(<table>) <integer>
...
\subsubsection src_http_req_rate <integer>
\subsubsection src_http_req_rate(<table>) <integer>
...
\subsubsection src_inc_gpc0 <integer>
\subsubsection src_inc_gpc0(<table>) <integer>
