...
\index{avg\_queue}
  ...
  new traffic to another backend if in better shape. See also: the \kwl{queue},
...
\index{connslots}
  ...
  available connection slots as well. See also: \kwl{queue} and \kwl{avg\_queue}.
...
\index{fe\_conn}
  ...
  considered saturated. See also: the \kwl{dst\_conn}, \kwl{be\_conn} and \kwl{fe\_sess\_rate}
  criteria.
...
See also: the \kwl{fe\_conn}, \kwl{be\_conn} and \kwl{queue} criteria.
...
\index{cook\_reg}
  ...
  regex matching is slower than other methods. See also: other \kwl{cook\_} criteria,
...
\index{hdr\_reg}
  ...
  is slower than other methods. See also: other \kwl{hdr\_} criteria, as well as
...
\index{path\_dir}
  ...
  matching without the risk of wrong match due to colliding prefixes. See also:   \kwl{url\_dir} and \kwl{path\_sub}.
...
\index{path\_dom}
  ...
  requests. See also: \kwl{path\_sub} and \kwl{url\_dom}.
...
\index{path\_reg}
  ...
  than other methods. See also: \kwl{url\_reg} and all \kwl{path\_} criteria.

\subsubsection[path\_sub]{\kw{path\_sub} <string>}
\index{path\_sub}

  Returns true when the path contains one of the strings. It can be used to
  detect particular patterns in paths, such as \cmd{../} for example. See also:   \kwl{path\_dir}.
...
\index{url\_dir}
  ...
  matching without the risk of wrong match due to colliding prefixes. See also:   \kwl{path\_dir} and \kwl{url\_sub}.
...
\index{url\_dom}
  ...
  wrong match due to colliding prefixes. See also: \kwl{url\_sub}.
...
\index{url\_reg}
  ...
  used any time, but it is important to remember that regex matching is slower
  than other methods. See also: \kwl{path\_reg} and all \kwl{url\_} criteria.

\subsubsection[url\_sub]{\kw{url\_sub} <string>}
\index{url\_sub}

  Returns true when the URL contains one of the strings. It can be used to
  detect particular patterns in query strings for example. See also: \kwl{path\_sub}.
...
\index{urlp\_dir}
  ...
  wrong match due to colliding prefixes. See also: \kwl{path\_dir} and \kwl{urlp\_sub}.
...
\index{urlp\_dom}
  ...
  prefixes. See also: \kwl{urlp\_sub}.
...
\index{urlp\_reg}
  ...
  regex matching is slower than other methods. See also: \kwl{path\_reg} and all
  "urlp\_" criteria.
